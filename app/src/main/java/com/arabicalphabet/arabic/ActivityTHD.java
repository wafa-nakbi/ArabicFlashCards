...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterTHD;

public class ActivityTHD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterTHD(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityTHD.this, a_sound[arg0]);
            mp.start();
        }
