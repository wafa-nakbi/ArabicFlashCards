...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterN;
...
public class ActivityN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterN(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityN.this, a_sound[arg0]);
            mp.start();
        }
