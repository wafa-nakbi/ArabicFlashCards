...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterD;
...
public class ActivityD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mp.start();
        ...
        viewPager.setAdapter(new CustomPagerAdapterD(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityD.this, a_sound[arg0]);
            mp.start();
        }
