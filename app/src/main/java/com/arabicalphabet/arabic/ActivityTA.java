...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterTA;

public class ActivityTA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterTA(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityTA.this, a_sound[arg0]);
            mp.start();
        }
