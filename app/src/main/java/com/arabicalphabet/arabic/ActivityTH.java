...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterTH;

public class ActivityTH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterTH(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityTH.this, a_sound[arg0]);
            mp.start();
        }
