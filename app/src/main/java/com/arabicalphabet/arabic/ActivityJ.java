...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterJ;
...
public class ActivityJ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mp.start();
        ...
        viewPager.setAdapter(new CustomPagerAdapterJ(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityJ.this, a_sound[arg0]);
            mp.start();
        }
