...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterC;
...
public class ActivityC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterC(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityC.this, a_sound[arg0]);
            mp.start();
        }
