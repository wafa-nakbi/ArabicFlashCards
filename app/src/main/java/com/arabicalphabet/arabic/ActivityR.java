...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterR;
...
public class ActivityR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterR(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityR.this, a_sound[arg0]);
            mp.start();
        }
