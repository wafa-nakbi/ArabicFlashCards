...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterSH;

public class ActivitySH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterSH(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivitySH.this, a_sound[arg0]);
            mp.start();
        }
