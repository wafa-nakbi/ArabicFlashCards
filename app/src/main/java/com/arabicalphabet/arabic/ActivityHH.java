...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterHH;

public class ActivityHH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterHH(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityHH.this, a_sound[arg0]);
            mp.start();
        }
