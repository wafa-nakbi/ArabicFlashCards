...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterAIN;

public class ActivityAIN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterAIN(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityAIN.this, a_sound[arg0]);
            mp.start();
        }
