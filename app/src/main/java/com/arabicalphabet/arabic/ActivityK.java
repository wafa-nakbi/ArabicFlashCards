...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterK;
...
public class ActivityK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new CustomPagerAdapterK(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityK.this, a_sound[arg0]);
            mp.start();
        }
