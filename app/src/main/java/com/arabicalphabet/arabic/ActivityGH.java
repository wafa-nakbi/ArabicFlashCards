...
import my.arabicalphabet.arabic.adapters.CustomPagerAdapterGH;

public class ActivityGH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mp.start();
        ...
        viewPager.setAdapter(new CustomPagerAdapterGH(this));
    ...
    OnPageChangeListener player = new OnPageChangeListener()
    {
        ...
        {
            MediaPlayer  mp = MediaPlayer.create(ActivityGH.this, a_sound[arg0]);
            mp.start();
        }
